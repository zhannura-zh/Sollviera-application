...
export const WaiterScreens: React.FC<WaiterScreensProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-[#FAF7F3] relative font-sans select-none">
        ...
        <div className="flex-1 flex flex-col min-h-0 bg-[#FAF7F3]">
          <div className="flex-1 overflow-y-auto no-scrollbar p-4.5 space-y-4">
            ...
            <div className="pt-2 pb-1">
              ...
              <p className="text-xs font-sans font-normal text-[#8A8177] pt-1">
                <strong className="text-[#241E1A] font-medium">2</strong> {lang === 'RU' ? 'доставки в работе · ' : 'deliveries active · '}
                <span className="text-[#B3261E] font-medium">
                  {lang === 'RU' ? '1 опаздывает' : '1 delayed'}
                </span>
              </p>
            </div>
            ...
            <div className="flex items-center gap-2 overflow-x-auto no-scrollbar">
              <button
                type="button"
                onClick={() => setRoomServiceFilter('DELIVERY')}
                className={`px-3.5 py-1.5 rounded-full text-xs font-sans transition-all cursor-pointer ${
                  roomServiceFilter === 'DELIVERY'
                    ? 'bg-[#241E1A] text-white font-medium shadow-xs'
                    : 'bg-white border border-[#E5E2DD] text-[#8A8177] hover:text-[#241E1A] font-normal'
                }`}
              >
                {lang === 'RU' ? 'Доставки' : 'Deliveries'} <span className="opacity-60 ml-1">2</span>
              </button>

              <button
                type="button"
                onClick={() => setRoomServiceFilter('BREAKFAST')}
                className={`px-3.5 py-1.5 rounded-full text-xs font-sans transition-all cursor-pointer ${
                  roomServiceFilter === 'BREAKFAST'
                    ? 'bg-[#241E1A] text-white font-medium shadow-xs'
                    : 'bg-white border border-[#E5E2DD] text-[#8A8177] hover:text-[#241E1A] font-normal'
                }`}
              >
                {lang === 'RU' ? 'Завтраки' : 'Breakfasts'} <span className="opacity-60 ml-1">6</span>
              </button>

              <button
                type="button"
                onClick={() => setRoomServiceFilter('TRAYS')}
                className={`px-3.5 py-1.5 rounded-full text-xs font-sans transition-all cursor-pointer ${
                  roomServiceFilter === 'TRAYS'
                    ? 'bg-[#241E1A] text-white font-medium shadow-xs'
                    : 'bg-white border border-[#E5E2DD] text-[#8A8177] hover:text-[#241E1A] font-normal'
                }`}
              >
                {lang === 'RU' ? 'Забрать подносы' : 'Pick up trays'} <span className="opacity-60 ml-1">3</span>
              </button>
            </div>
            ...
            <div className="space-y-2 pt-1">
              <span className="text-[10px] font-sans font-medium tracking-[0.08em] text-[#8A8177] uppercase block select-none">
                {lang === 'RU' ? 'ДОСТАВКИ' : 'DELIVERIES'}
              </span>

              <div className="bg-white rounded-[20px] border border-[#E5E2DD] divide-y divide-[#E5E2DD]/50 shadow-2xs overflow-hidden">
                {roomDeliveries.map((del) => (
                  <div
                    key={del.id}
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <span className={`h-2 w-2 rounded-full shrink-0 ${del.dotColor}`} />
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          <span className="text-sm font-sans font-medium text-[#241E1A]">
                            {del.roomNumber}
                          ...
                          {del.tag && (
                            <span className="bg-[#FAF0EF] text-[#B3261E] text-[9px] font-sans font-medium px-1.5 py-0.5 rounded leading-none">
                              {del.tag}
                            </span>
                          )}
                          <span className={`text-[10px] font-sans ${del.tag ? 'text-[#B3261E] font-medium' : 'text-[#8A8177]'}`}>
                            {del.dueTime}
                          </span>
                        </div>
                        <p className="text-[10px] font-sans font-normal text-[#8A8177] mt-0.5 truncate">
                          {lang === 'RU' ? del.itemsDescRu : del.itemsDescEn}
                        </p>
                      </div>
                    </div>
                    <ChevronRight className="h-4 w-4 text-[#8A8177] shrink-0" />
            ...
            {/* Section 2: ЗАВТРАКИ НА ЗАВТРА */}
            <div className="space-y-2 pt-1">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-sans font-medium tracking-[0.08em] text-[#8A8177] uppercase block select-none">
                  {lang === 'RU' ? 'ЗАВТРАКИ НА ЗАВТРА' : 'TOMORROW BREAKFASTS'}
                </span>
                <span className="text-xs font-sans font-normal text-[#8A8177]">
                  {lang === 'RU' ? 'приём до 23:00' : 'orders until 23:00'}
                </span>
              </div>

              <div className="bg-white rounded-[20px] border border-[#E5E2DD] divide-y divide-[#E5E2DD]/50 shadow-2xs overflow-hidden">
                {/* Slot 1: 07:00–07:30 */}
                <div className="p-3 bg-[#FAF7F3]/70 text-[10px] font-sans font-medium tracking-wider text-[#8A8177]">
                  07:00–07:30
                </div>
                <div className="p-3.5 flex items-center justify-between">
                  <div className="flex items-center gap-3 min-w-0">
                    <span className="h-2 w-2 rounded-full shrink-0 bg-[#E5E2DD]" />
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-sans font-medium text-[#241E1A]">№ 304</span>
                        <span className="bg-[#FAF0EB] text-[#C2410C] text-[9px] font-sans font-medium px-1.5 py-0.5 rounded leading-none">HB</span>
                        <span className="text-[10px] font-sans text-[#8A8177]">2 гостя</span>
                      </div>
                      <p className="text-[10px] font-sans font-normal text-[#8A8177] mt-0.5 truncate">
                        Континентальный, кофе · без орехов
                      </p>
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[#8A8177] shrink-0" />
                ...
                <div className="p-3.5 flex items-center justify-between">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-sans font-medium text-[#241E1A]">№ 412</span>
                        <span className="bg-[#FAF0EB] text-[#C2410C] text-[9px] font-sans font-medium px-1.5 py-0.5 rounded leading-none">AI</span>
                        <span className="text-[10px] font-sans text-[#8A8177]">2 гостя</span>
                      </div>
                      <p className="text-[10px] font-sans font-normal text-[#8A8177] mt-0.5 truncate">
                        Английский, свежий сок
                      </p>
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[#8A8177] shrink-0" />
                ...
                <div className="p-3.5 flex items-center justify-between">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-sans font-medium text-[#241E1A]">№ 208</span>
                        <span className="bg-[#FAF0EB] text-[#C2410C] text-[9px] font-sans font-medium px-1.5 py-0.5 rounded leading-none">BB</span>
                        <span className="text-[10px] font-sans text-[#8A8177]">1 гость</span>
                      </div>
                      <p className="text-[10px] font-sans font-normal text-[#8A8177] mt-0.5 truncate">
                        Омлет, чай
                      </p>
                ...
                <div className="p-3.5 flex items-center justify-between">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-sans font-medium text-[#241E1A]">№ 105</span>
                        <span className="bg-[#FAF0EB] text-[#C2410C] text-[9px] font-sans font-medium px-1.5 py-0.5 rounded leading-none">FB</span>
                        <span className="text-[10px] font-sans text-[#8A8177]">3 гостя</span>
                      </div>
                      <p className="text-[10px] font-sans font-normal text-[#8A8177] mt-0.5 truncate">
                        Континентальный ×2, детский
                      </p>
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[#8A8177] shrink-0" />
                ...
                <div className="p-3.5 flex items-center justify-between">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-sans font-medium text-[#241E1A]">№ 311</span>
                        <span className="bg-[#FAF0EB] text-[#C2410C] text-[9px] font-sans font-medium px-1.5 py-0.5 rounded leading-none">BB</span>
                        <span className="text-[10px] font-sans text-[#8A8177]">2 гостя</span>
                      </div>
                      <p className="text-[10px] font-sans font-normal text-[#8A8177] mt-0.5 truncate">
            ...
            {/* Section 3: ЗАБРАТЬ ПОДНОСЫ */}
            <div className="space-y-2 pt-1 pb-4">
              <span className="text-[10px] font-sans font-medium tracking-[0.08em] text-[#8A8177] uppercase block select-none">
                {lang === 'RU' ? 'ЗАБРАТЬ ПОДНОСЫ' : 'PICK UP TRAYS'}
              </span>

              <div className="bg-white rounded-[20px] border border-[#E5E2DD] divide-y divide-[#E5E2DD]/50 shadow-2xs overflow-hidden">
                <div className="p-3.5 flex items-center justify-between">
                  <div className="flex items-center gap-3 min-w-0">
                    <span className="h-2 w-2 rounded-full shrink-0 bg-[#5C6B7A]" />
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-sans font-medium text-[#241E1A]">№ 105</span>
                        <span className="text-[10px] font-sans text-[#8A8177]">выставлен 11:40</span>
                      </div>
                      <p className="text-[10px] font-sans font-normal text-[#8A8177] mt-0.5 truncate">
                        3 этаж · передано хаускипингу
                      </p>
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[#8A8177] shrink-0" />
                ...
                <div className="p-3.5 flex items-center justify-between">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-sans font-medium text-[#241E1A]">№ 402</span>
                        <span className="text-[10px] font-sans text-[#8A8177]">выставлен 12:05</span>
                      </div>
                      <p className="text-[10px] font-sans font-normal text-[#8A8177] mt-0.5 truncate">
                        4 этаж
                      </p>
          ...
          {/* Bottom CTA Button: Принять заказ в номер */}
          <div className="p-4 bg-[#FAF7F3] border-t border-[#E5E2DD] shrink-0">
            <button
              type="button"
              ...
              className="w-full bg-[#C2410C] hover:bg-[#A93A0C] active:scale-[0.99] text-white font-sans font-medium text-sm py-3.5 rounded-xl shadow-xs transition-all cursor-pointer text-center"
            >
              {lang === 'RU' ? 'Принять заказ в номер' : 'New Room Service Order'}
            </button>
          </div>
        </div>
      )}
      ...
      {/* ========================================================================= */}
      {/* -------------------- TAB 4: МЕНЮ И СТОП-ЛИСТ (WAITER_MENU) ------------- */}
      {/* ========================================================================= */}
        ...
        <div className="flex-1 flex flex-col min-h-0 bg-[#FAF7F3]">
          <div className="flex-1 overflow-y-auto no-scrollbar p-4.5 space-y-4">
            ...
            <div className="pt-2 pb-1">
              ...
              <p className="text-xs font-sans font-normal text-[#8A8177] pt-1">
                <span className="text-[#B3261E] font-medium">{lang === 'RU' ? '3 позиции в стоп-листе' : '3 items in stop-list'}</span> · {lang === 'RU' ? '2 заканчиваются' : '2 running low'}
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-[#E5E2DD] px-3.5 py-2.5 flex items-center gap-2.5 shadow-2xs">
              ...
              <input
                type="text"
                placeholder={lang === 'RU' ? 'Поиск по блюду или составу' : 'Search dish or ingredients'}
            ...
            <div className="flex items-center gap-2 overflow-x-auto no-scrollbar">
              ...
              <button
                type="button"
                onClick={() => setMenuCategoryFilter('STARTER')}
                className={`px-3.5 py-1.5 rounded-full text-xs font-sans transition-all cursor-pointer ${
                  menuCategoryFilter === 'STARTER'
                    ? 'bg-[#241E1A] text-white font-medium shadow-xs'
                    : 'bg-white border border-[#E5E2DD] text-[#8A8177] hover:text-[#241E1A] font-normal'
                }`}
              >
                {lang === 'RU' ? 'Закуски' : 'Starters'}
              </button>
              <button
                type="button"
                onClick={() => setMenuCategoryFilter('MAIN')}
                className={`px-3.5 py-1.5 rounded-full text-xs font-sans transition-all cursor-pointer ${
                  menuCategoryFilter === 'MAIN'
                    ? 'bg-[#241E1A] text-white font-medium shadow-xs'
                    : 'bg-white border border-[#E5E2DD] text-[#8A8177] hover:text-[#241E1A] font-normal'
                }`}
              >
                {lang === 'RU' ? 'Основное' : 'Mains'}
              </button>
              <button
                type="button"
                onClick={() => setMenuCategoryFilter('DESSERT')}
                className={`px-3.5 py-1.5 rounded-full text-xs font-sans transition-all cursor-pointer ${
                  menuCategoryFilter === 'DESSERT'
                    ? 'bg-[#241E1A] text-white font-medium shadow-xs'
                    : 'bg-white border border-[#E5E2DD] text-[#8A8177] hover:text-[#241E1A] font-normal'
                }`}
              >
                {lang === 'RU' ? 'Десерты' : 'Desserts'}
              </button>
              <button
                type="button"
                onClick={() => setMenuCategoryFilter('DRINK')}
                className={`px-3.5 py-1.5 rounded-full text-xs font-sans transition-all cursor-pointer ${
                  menuCategoryFilter === 'DRINK'
                    ? 'bg-[#241E1A] text-white font-medium shadow-xs'
                    : 'bg-white border border-[#E5E2DD] text-[#8A8177] hover:text-[#241E1A] font-normal'
                }`}
              >
            ...
            <div className="space-y-2 pt-1">
              ...
              <div className="bg-white rounded-[20px] border border-[#E5E2DD] border-l-4 border-l-[#B3261E] divide-y divide-[#E5E2DD]/50 shadow-2xs overflow-hidden">
                <div className="p-3.5">
                  <h4 className="text-sm font-sans font-medium line-through text-[#8A8177]">
                    {lang === 'RU' ? 'Утиная ножка конфи' : 'Duck leg confit'}
                  </h4>
                  <p className="text-xs font-sans font-normal text-[#B3261E] mt-0.5">
                    {lang === 'RU' ? 'основное · снято в 11:20' : 'main · removed at 11:20'}
                  </p>
                </div>
                <div className="p-3.5">
                  <h4 className="text-sm font-sans font-medium line-through text-[#8A8177]">
                    {lang === 'RU' ? 'Морской окунь' : 'Sea bass'}
                  </h4>
                  <p className="text-xs font-sans font-normal text-[#B3261E] mt-0.5">
                    {lang === 'RU' ? 'основное · до вечерней поставки' : 'main · until evening delivery'}
                  </p>
                </div>
                <div className="p-3.5">
                  <h4 className="text-sm font-sans font-medium line-through text-[#8A8177]">
                    {lang === 'RU' ? 'Тирамису' : 'Tiramisu'}
                  </h4>
                  <p className="text-xs font-sans font-normal text-[#B3261E] mt-0.5">
                    {lang === 'RU' ? 'десерт · снято в 09:05' : 'dessert · removed at 09:05'}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2 pt-1">
              <span className="text-[10px] font-sans font-medium tracking-[0.08em] text-[#8A8177] uppercase block select-none">
                {lang === 'RU' ? 'ЗАКАНЧИВАЕТСЯ' : 'RUNNING LOW'}
              </span>

              <div className="bg-white rounded-[20px] border border-[#E5E2DD] border-l-4 border-l-[#E4762B] divide-y divide-[#E5E2DD]/50 shadow-2xs overflow-hidden">
                <div className="p-3.5 flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-sans font-medium text-[#241E1A]">
                      {lang === 'RU' ? 'Стейк рибай' : 'Ribeye steak'}
                    </h4>
                    <p className="text-xs font-sans font-normal text-[#8A5210] mt-0.5">
                      {lang === 'RU' ? 'осталось 6 порций' : '6 portions left'}
                    </p>
                  </div>
                  <span className="text-xs font-sans font-medium text-[#5B8C6E]">
                    {lang === 'RU' ? 'по пакету' : 'included'}
                  </span>
                </div>
                <div className="p-3.5 flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-sans font-medium text-[#241E1A]">
                      {lang === 'RU' ? 'Вино красное, бокал' : 'Red wine, glass'}
                    </h4>
                    <p className="text-xs font-sans font-normal text-[#8A5210] mt-0.5">
                      {lang === 'RU' ? 'осталось 4 порции' : '4 portions left'}
                    </p>
                  </div>
            ...
            <div className="space-y-2 pt-1">
              ...
              <div className="bg-white rounded-[20px] border border-[#E5E2DD] divide-y divide-[#E5E2DD]/50 shadow-2xs overflow-hidden">
                <div className="p-3.5 flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-sans font-medium text-[#241E1A]">
                      {lang === 'RU' ? 'Паста карбонара' : 'Pasta carbonara'}
                    </h4>
                    <p className="text-xs font-sans font-normal text-[#8A8177] mt-0.5">
                      {lang === 'RU' ? '12 мин · содержит глютен, яйцо' : '12 min · gluten, egg'}
                    </p>
                  </div>
                  <span className="text-xs font-sans font-medium text-[#241E1A]">
                    2 400 ₸
                ...
                <div className="p-3.5 flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-sans font-medium text-[#241E1A]">
                      {lang === 'RU' ? 'Судак на пару' : 'Steamed pike perch'}
                    </h4>
                    <p className="text-xs font-sans font-normal text-[#8A8177] mt-0.5">
                      {lang === 'RU' ? '15 мин · содержит рыбу' : '15 min · fish'}
                    </p>
                  </div>
                  <span className="text-xs font-sans font-medium text-[#5B8C6E]">
                    {lang === 'RU' ? 'по пакету' : 'included'}
                ...
                <div className="p-3.5 flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-sans font-medium text-[#241E1A]">
                      {lang === 'RU' ? 'Лосось гриль' : 'Grilled salmon'}
                    </h4>
                    <p className="text-xs font-sans font-normal text-[#8A8177] mt-0.5">
                      {lang === 'RU' ? '16 мин · содержит рыбу' : '16 min · fish'}
                    </p>
                  </div>
                  <span className="text-xs font-sans font-medium text-[#241E1A]">
                    5 200 ₸
                ...
                <div className="p-3.5 flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-sans font-medium text-[#241E1A]">
                      {lang === 'RU' ? 'Плов с бараниной' : 'Lamb plov'}
                    </h4>
                    <p className="text-xs font-sans font-normal text-[#8A8177] mt-0.5">
                      {lang === 'RU' ? '14 мин' : '14 min'}
                    </p>
                  </div>
                  <span className="text-xs font-sans font-medium text-[#5B8C6E]">
                    {lang === 'RU' ? 'по пакету' : 'included'}
            ...
            <div className="space-y-2 pt-1 pb-6">
              <span className="text-[10px] font-sans font-medium tracking-[0.08em] text-[#8A8177] uppercase block select-none">
                {lang === 'RU' ? 'ДЕТСКОЕ МЕНЮ' : 'KIDS MENU'}
              </span>
              ...
              <div className="bg-white rounded-[20px] border border-[#E5E2DD] divide-y divide-[#E5E2DD]/50 shadow-2xs overflow-hidden">
                <div className="p-3.5 flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-sans font-medium text-[#241E1A]">
                      {lang === 'RU' ? 'Куриные наггетсы' : 'Chicken nuggets'}
                    </h4>
                    <p className="text-xs font-sans font-normal text-[#8A8177] mt-0.5">
                      {lang === 'RU' ? '10 мин' : '10 min'}
                    </p>
                  </div>
                  <span className="text-xs font-sans font-medium text-[#5B8C6E]">
                    {lang === 'RU' ? 'по пакету' : 'included'}
                ...
                <div className="p-3.5 flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-sans font-medium text-[#241E1A]">
                      {lang === 'RU' ? 'Молочная каша' : 'Milk porridge'}
                    </h4>
                    <p className="text-xs font-sans font-normal text-[#8A8177] mt-0.5">
                      {lang === 'RU' ? '8 мин · содержит молоко' : '8 min · milk'}
                    </p>
                  </div>
                  <span className="text-xs font-sans font-medium text-[#5B8C6E]">
                    {lang === 'RU' ? 'по пакету' : 'included'}
